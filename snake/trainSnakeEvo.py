...
network = classe.CNN([
    classe.FullyConnectedLayer(GAMESIZE**2*3,150,classe.Tanh,LEARNING_RATE,1),
    classe.FullyConnectedLayer(150,150,classe.Tanh,LEARNING_RATE,1),
    classe.FullyConnectedLayer(150,4,classe.Sigmoid,LEARNING_RATE,1)
])
